...
import { updatePasswd } from "../../auth/authActions";
import { updateProfile } from "../../user/userActions";

function SettingsDashboard({ updatePasswd, updateProfile, providerId, user }) {
  //const updPro = { updateProfile };
  console.log("friggin user", user);
  return (
    <Grid>
      <Grid.Column width={12}>
        <Switch>
          ...
          <Route
            ...
            render={() => (
              <AccountPage updPasswd={updatePasswd} providerId={providerId} />
            )}
          />
        </Switch>
      </Grid.Column>
